...
### 3.- ¿Cómo ejecutar código nativo desde flutter?
    Para ejecutar código nativo desde flutter utilizamos MethodChannel que nos ayudara a comunicarnos con el código (Kotlin o Switf) para obtener la data que llega atravez de este puente, poder utilizar sensores, la cámara u obtener información del dispotivo.
...
### 6.- ¿Que es una dependencia y como la instalas?
    Son paquetes desarrollados por otros desarrolladores en el mismo ecosistema que nos ayudan a contruir aplicaciones más rápido sin tener que hacerlo desde cero; nosotros también podemos crear estás dependencias o plugins para aislar o reutilizar en varios proyectos alguna función.
...
### 7 .- ¿Qué es “context (contexto)” y cómo funciona?
    El context o contexto de una aplicación es como un contenedor de información de toda nuestra aplicación que se transmite a travez del arbol de pantallas o widgets desde el elemento principal al secundario, lo que permite a los widgets secundarios acceder a  un elemento del widget principal. Por ejemplo, acceder al tema de la aplicación, propiedades como colores, fuentes, tamaños de letra, tamaños de pantalla.
